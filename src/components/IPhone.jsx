    ...
    useEffect(() => {
        if (materials) {
            Object.entries(materials).forEach(([key, material]) => {
                // Skip these material names that can't be changed color
                if (
                    key !== "zFdeDaGNRwzccye" &&
                    key !== "ujsvqBWRMnqdwPx" &&
                    key !== "hUlRcbieVuIiOXG" &&
                    ...
                    material.color = new THREE.Color(props.item.color[0]); // Reapply color
                    material.needsUpdate = true;
                }
            });
        }
    }, [props.item.color, materials]);  // Reapply color on model change
